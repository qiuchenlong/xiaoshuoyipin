...
<header class="header">
    ...
    <div class="breadcrumbs">
        ...
        <a class="nav_a current" href="<?php echo U('index');?>">女频</a>
        <a class="nav_a" href="<?php echo U('index_male');?>">男频</a>
        <a class="nav_a" href="<?php echo U('index_publish');?>">出版</a>
        <!--<a class="nav_a" href="<?php echo U('Shuku/index');?>">书库</a>-->
        </div>
    </div>
</header>
<div class="content">
    <div class="m-swiper">
        <div class="swiper-container">
            ...
            <?php if(is_array($lunbo)): foreach($lunbo as $key=>$v): ?><div class="swiper-slide">
                <?php if($v["gotos"] == 0): ?><a href="<?php echo ($v["weburl"]); ?>"><?php endif; ?>

                <?php if($v["gotos"] == 1): ?><a href="<?php echo ($v["weburl"]); ?>"><?php endif; ?>

                <?php if($v["gotos"] == 2): ?><a href="<?php echo ($v["weburl"]); ?>"><?php endif; ?>
