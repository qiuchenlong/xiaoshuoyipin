...
<header class="header">
    ...
    <div class="breadcrumbs" >
        ...
        <div class="nav">
            <a class="nav_a current" href="index.html">女频</a>
            <a class="nav_a" href="nan.html">男频</a>
...
<footer class="footer">
    ...
    <div class="menu">
        ...
        <a class="footer_a current" href="<?php echo U('Shuku/index');?>"> <i class="iconfont icon-yg-shujia"></i> <span>书库</span></a>
