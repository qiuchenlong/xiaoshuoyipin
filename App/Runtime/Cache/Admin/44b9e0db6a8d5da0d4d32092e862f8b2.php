...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 轮播图管理 <span class="c-gray en">&gt;</span> 书单列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav> 
	
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <i ></i> </a><?php if($_SESSION["guanli"] != null): ?><a onclick="picture_add('新增书单','<?php echo U('add');?>')" href="javascript:;"  class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加书单</a><?php endif; ?></span> <span class="r">共有数据：<strong><?php echo ($shu); ?></strong> 条</span> </div>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort" width="100%">
					<thead>
						<tr class="text-c"> 
							...
							<?php if($_SESSION["guanli"] != null): ?><th width="80">操作</th><?php endif; ?>
							 
						</tr> 
						<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr class="text-c"> 
							<td width="100"><?php echo ($v["id"]); ?></td>
							<td width="80"><img src="/Public/<?php echo ($v["images"]); ?>" width="50"></td>
							<td width="80"><img src="/Public/<?php echo ($v["imagest"]); ?>" width="50"></td>
							<td width="80"><img src="/Public/<?php echo ($v["imagess"]); ?>" width="50"></td>
							<td width="100"><?php echo ($v["gotos"]); ?></td>
							<!-- <td width="100">
							<?php if($v["path"] == 1): ?>女频轮播
							<?php elseif($v["path"] == 2): ?>男频轮播
							<?php elseif($v["path"] == 3): ?>情欲轮播
							<?php elseif($v["path"] == 4): ?>免费轮播<?php endif; ?>
							</td> -->
							<td width="100"><?php echo ($v["title"]); ?></td>
							
							<td width="100"><?php echo ($v["weburl"]); ?></td>
							<td width="30"><?php echo ($v["views"]); ?></td>
							
							
							
							
							
							<?php if($_SESSION["guanli"] != null): ?><td width="80"><a title="编辑"  onclick="picture_edit('修改书单','<?php echo U('edit');?>?id=<?php echo ($v["id"]); ?>')" href="javascript:;"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> &nbsp;&nbsp;&nbsp;&nbsp; <a  href="<?php echo U('del');?>?id=<?php echo ($v["id"]); ?>" class="ml-5"><i class="Hui-iconfont">&#xe6e2;</i></a></td><?php endif; ?>
