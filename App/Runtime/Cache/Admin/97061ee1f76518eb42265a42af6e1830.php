...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 频道管理 <span class="c-gray en">&gt;</span> 搜索列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav> 
	
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <i ></i> </a><?php if($_SESSION["guanli"] != null): ?><a onclick="picture_add('添加搜索','<?php echo U('add');?>')"  class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加搜索</a><?php endif; ?> </span><span class="r">共有数据：<strong><?php echo ($shu); ?></strong> 条</span> </div>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort" width="100%">
					<thead>
						<tr class="text-c"> 
							...
							<th>ID</th>
							<th>搜索内容</th>
							<?php if($_SESSION["guanli"] != null): ?><th>操作</th><?php endif; ?>
							 
						</tr> 
						<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr class="text-c"> 
							<!-- <td width="100"><?php echo ($v["sortid"]); ?></td> -->
							
							<td><?php echo ($v["cacheid"]); ?></td>
							<td><?php echo ($v["keywords"]); ?></td>
							<?php if($_SESSION["guanli"] != null): ?><td >								
								<a title="修改" onclick="picture_add('修改标签','<?php echo U('edit');?>?id=<?php echo ($v["cacheid"]); ?>')" class="ml-5" style="text-decoration:none">
									<i class="Hui-iconfont">&#xe6df;</i>
								</a> &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								<a  href="<?php echo U('del');?>?id=<?php echo ($v["cacheid"]); ?>" class="ml-5" title="删除">
									<i class="Hui-iconfont">&#xe6e2;</i>
								</a>
							</td><?php endif; ?>
