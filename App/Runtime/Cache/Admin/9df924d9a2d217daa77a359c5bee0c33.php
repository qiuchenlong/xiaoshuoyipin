...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont"></i> <a href="<?php echo U('Index/index');?>" class="maincolor">首页</a> 
		<span class="c-999 en">&gt;</span>
		<span class="c-666">我的桌面</span> 
		<a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="Hui-article"> 
		<article class="cl pd-20">
			<p class="f-20 text-success">欢迎使用小说管理
				<span class="f-14">v2.3</span> 
				后台模版！</p>
			<p>登录次数：<?php echo ($message["login_count"]); ?></p>
			<p>上次登录IP：<?php echo ($message["last_ip"]); ?> &nbsp;&nbsp;&nbsp;&nbsp;  上次登录时间：<?php echo ($message["last_time"]); ?></p> 
 ...
 -->						<!-- <th>商品总量</th> -->
			...
			<tbody id="changetr">
					...
					<tr class="text-c success">
						<td>今日</td> 
						<td><?php echo ($ri); ?></td>
						<!-- <td><?php echo ($pageview["today_pageview"]); ?></td>
						 <td><?php echo ($order["today_order"]); ?></td> -->
						<!--<td><?php echo ($goods["today_goods"]); ?></td>  -->
			  </tr>
					
					<tr class="text-c success">
						<td>本月</td>  
						<td><?php echo ($yue); ?></td>
						<!--  <td><?php echo ($pageview["month_pageview"]); ?></td>
						<td><?php echo ($order["month_order"]); ?></td> -->
						<!--<td><?php echo ($goods["month_goods"]); ?></td>  -->
			</tr>
		</tbody>
	</table>
		...
		<footer class="footer"> 
			<p><br> 本后台系统由<a href="http://www.h-ui.net/" target="_blank" title="放飞科技邮箱公司">放飞科技邮箱公司</a>提供技术支持</p> 
</footer> 
</div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript">
$("#changetr .text-c").mouseover(function(){
	calss = $(this).attr('class');   
	// alert(1);
   $(this).removeClass().addClass("text-c xixi");
   $(this).children('td').addClass('xixi');  

}).mouseout(function(){  
	$(this).removeClass().addClass(calss);    
