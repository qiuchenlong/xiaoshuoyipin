...
<section class="Hui-article-box">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 频道管理 <span class="c-gray en">&gt;</span> 用户分享记录 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav> 
	
	
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <i ></i>  </span><span class="r">共有数据：<strong><?php echo ($shu); ?></strong> 条</span> </div>
				...
				<table class="table table-border table-bordered table-bg table-hover table-sort" width="100%">
					<thead>
						...
						<?php if(is_array($arr)): foreach($arr as $key=>$v): ?><tr class="text-c"> 
							...
							<td width="30"><?php echo ($v["content"]); ?></td>
							...
							<!-- <?php if($_SESSION["guanli"] != null): ?><td >
								...
								<a title="修改" onclick="picture_add('修改','<?php echo U('xinxiedit');?>?id=<?php echo ($v["id"]); ?>')"  class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>  &nbsp; &nbsp; <a  onclick="del('<?php echo ($v["id"]); ?>') " class="ml-5" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a></td><?php endif; ?> -->
...
function del(id){
	...
	con=confirm("确定删除吗?"); //在页面上弹出对话框
	if(con==true){
		location.href="<?php echo U('xinxidel');?>?id="+id+"";
	}
}  
</script>
<!--/请在上方写此页面业务相关的脚本-->
