...
class MenuController extends CommonController
{
    ...
    public function index()
    {
        ...
        foreach ($result as $key => $value) {
            ...
            $result[$key]['str_manage']     = '<a href="' . url("Menu/add", ["parent_id" => $value['id'], "menu_id" => $_REQUEST["menu_id"]])
                . '">添加子菜单</a>  <a href="' . url("Menu/edit", ["id" => $value['id'], "menu_id" => $_REQUEST["menu_id"]])
                . '">编辑</a>  <a class="js-ajax-delete" href="' . url("Menu/delete", ["id" => $value['id'], "menu_id" => $_REQUEST["menu_id"]]) . '">删除</a> ';
