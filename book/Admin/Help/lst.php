<form id="pagerForm" method="post" action="?m=FeiAdmin&c=HelpCenter&a=lst">
...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="?m=FeiAdmin&c=HelpCenter&a=lst" method="post">
        <div class="searchBar">
...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            <li><a class="add" href="{:U('HelpCenter/add')}" target="dialog" width="800" height="600"><span>添加</span></a></li>
    ...
    <div id="w_list_print">
        <table class="list" width="98%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
            ...
            <tr>
                ...
                <th align="center" width="60">热点问题</th>
            ...
            <volist name="data" id="v">
                <tr target="{$v.h_id}" rel="1">
                    ...
                    <td align="center">{$v.h_id}</td>
                    <td align="center">{$v.title}</td>
                    <td align="center">{$v.addtime}</td> 
                    <!-- <td><a href="index.php?m=Admin&c=HelpCenter&a=editwen&id={$v.h_id}" target="dialog" width="800" height="600">修改</a></td> -->
                </tr>
            </volist>
            </tbody>
        </table> 
