...
<div class="pageContent">
    <form method="post" action="?m=FeiAdmin&c=Sysinfomation&a=add" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            <p>
                <label>消息标题：</label>
                <input type="text" name="title" size="30" class="require" />
            </p>
