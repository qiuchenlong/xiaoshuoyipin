...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="?m=FeiAdmin&c=SonClassify&a=showList" method="post">
        <div class="searchBar"> 
        ...
        <table class="list" width="98%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
            ...
            <volist name="classifyList" id="SonClassify">
                <tr target="{$SonClassify.seclassify_id}" rel="1">
                    ...
                    <td align="center"><a href="?m=FeiAdmin&c=SonClassify&a=changeOne&id={$SonClassify.seclassify_id}" target="dialog" width="800" height="600">修改</a></td> 
                </tr>
            </volist>
            </tbody>
        </table> 
