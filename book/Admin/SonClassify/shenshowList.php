<form id="pagerForm" method="post" action="?m=FeiAdmin&c=SonClassify&a=shenshowList">
...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="?m=FeiAdmin&c=SonClassify&a=shenshowList" method="post">
        <div class="searchBar"> 
    ...
    <div id="w_list_print">
        <table class="list" width="98%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
            ...
            <tr>
                ...
                <th align="center" width="100" orderField="num">子分类图片</th>
            ...
            <volist name="classifyList" id="SonClassify">
                <tr target="{$SonClassify.seclassify_id}" rel="1">
                    ...
                    <td align="center"><?php echo showImage($SonClassify['se_images'],50,50)?></td>
                    <td align="center">{$SonClassify.classifyname}</td>  
                    <td align="center"><a href="?m=FeiAdmin&c=SonClassify&a=changeshen&id={$SonClassify.seclassify_id}" target="ajax" rel="shenhe_list" title="确定审核通过吗？">审核</a></td>    
                </tr>
            </volist>
            </tbody>
        </table> 
