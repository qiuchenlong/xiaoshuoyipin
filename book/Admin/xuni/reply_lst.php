<form id="pagerForm" method="post" action="?m=FeiAdmin&c=Index&a=reply_lst">
...
<div class="pageHeader">
    <form rel="pagerForm" onsubmit="return navTabSearch(this);" action="?m=FeiAdmin&c=Index&a=reply_lst" method="post">
        <div class="searchBar">
...
<div class="pageContent"> 
    <div class="panelBar"> 
        <ul class="toolBar"> 
            <li><a class="add" href="{:U('Index/reply_add')}" target="dialog" width="800" height="600"><span>添加</span></a></li>
    ...
    <div id="w_list_print">
        <table class="list" width="98%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
            ...
            <tr>
                ...
                <th align="center" width="60">评论</th>
                <!-- <th align="center" width="60">修改</th> -->
            </tr>
            </thead>
            <tbody id="Classifys"> 
            <volist name="data" id="v"> 
                <tr target="{$v.talkreply_id}" rel="1"> 
                    <td align="center" width="20">{$i}</td> 
                    <td align="center">{$v.talkreply_id}</td>
