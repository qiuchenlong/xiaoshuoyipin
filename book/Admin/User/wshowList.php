<form id="pagerForm" method="post" action="?m=FeiAdmin&c=User&a=wshowList">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="?m=FeiAdmin&c=User&a=wshowList" method="post"> 
        <div class="searchBar"> 
