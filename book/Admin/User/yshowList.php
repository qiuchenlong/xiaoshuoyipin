<form id="pagerForm" method="post" action="?m=FeiAdmin&c=User&a=yshowList">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="?m=FeiAdmin&c=User&a=yshowList" method="post">
		<div class="searchBar">
