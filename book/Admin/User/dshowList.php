<form id="pagerForm" method="post" action="?m=FeiAdmin&c=User&a=dshowList">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="?m=FeiAdmin&c=User&a=dshowList" method="post">
		<div class="searchBar">
