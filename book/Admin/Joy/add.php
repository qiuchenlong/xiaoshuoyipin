...
<div class="pageContent">
    <form method="post" action="?m=FeiAdmin&c=Joy&a=add" class="pageForm required-validate" onsubmit="return validateCallback(this,dialogAjaxDone);">
        <div class="pageFormContent" layoutH="56">
            <p>
                <label>游戏名称：</label>
                <input type="text" name="name" size="30" class="require" />
            </p>
            <p>
                <label>游戏简介：</label>
                <input type="text" name="jianjie" size="30" class="require" />
            </p>
            <p>
                <label>下载地址：</label>
                <input type="text" name="down_url" size="30" class="require" />
            </p>
            <p>
                <label>游戏分类：</label>
                <input type="text" name="fenlei" size="30" class="require" />
            </p>
             <p>
                <label>排序：</label>
                <input type="text" name="pai" size="30" class="require" />
            </p>
