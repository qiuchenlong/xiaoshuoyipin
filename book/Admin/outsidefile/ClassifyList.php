...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="index.php?c=Classify&a=addClassify" target="dialog" width="800" height="600"><span>添加</span></a></li>
...
<script>
	...
	function mySort(elem,id){
		var sort = $(elem).val();
		$.ajax({
			url:"index.php?c=Classify&a=ChangeSort&sort="+sort+'&id='+id,
			method:'get'
		}).done(function(ret){
